...
def explore_projects():
    ...
    st.write("We develop cutting-edge projects in AI, ML, and more. Visit our [project page](https://www.linkedin.com/in/mahendra-baghel-665989249?utm_source=share_via&utm_content=profile&utm_medium=member_android) to learn more.")
...
def about_section():
    ...
    <div class="icons" style="display: flex; justify-content: center; gap: 40px;">
        <div class="icon">
            <a href="https://github.com/mahendra7828" target="_blank">
                <img src="https://i.ibb.co/fYynxNn/git.png" alt="GitHub" width="100px" height="100px">
                GitHub
            </a>
        </div>
        <div class="icon">
            <a href="https://www.linkedin.com/in/mahendra-baghel-665989249?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank">
    ...
    ### Contact:
    - For queries or support, reach out to me at: [msb10102005@gmail.com](mailto:msb10102005@gmail.com)
    """)
...
def footer():
    st.markdown("""
        <div class="footer">
            Crafted with ❤️ by <a href="https://www.linkedin.com/in/mahendra-baghel-665989249?utm_source=share_via&utm_content=profile&utm_medium=member_android">@Mahendra</a>.
        </div>
    """, unsafe_allow_html=True)
